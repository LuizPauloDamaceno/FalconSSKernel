...
static struct pll_freq_tbl apcs_pll_freq[] = {
	...
	F_APCS_PLL(1305600000, 67, 0x0, 0x1, 0x0, 0x0, 0x0),
	PLL_F_END
};
...
static struct clk_freq_tbl ftbl_oxili_gfx3d_clk[] = {
	...
	F_MM(450000000, mmpll1,  2.5, 0, 0),
	F_MM(525000000,  gpll0,  1, 0, 0),
	F_END,
};
...
static struct rcg_clk gfx3d_clk_src = {
	...
	.c = {
		...
		.ops = &clk_ops_rcg,
		VDD_DIG_FMAX_MAP3(LOW, 100000000, NOMINAL, 300000000, HIGH,
					525000000),
...
/* MMPLL1 at 1320 MHz, main output enabled. */
